...
func TestParseStatementFallsBackToCLABEAndSpacedCompactDates(t *testing.T) {
	...
	if statement.AccountNumber != "0000000002" {
		t.Fatalf("unexpected account %q", statement.AccountNumber)
	}
	if statement.Currency != "USD" {
		t.Fatalf("unexpected currency %q", statement.Currency)
...
PeriodoDEL 23/12/2025 AL 22/01/2026Fecha de Corte 22/01/2026No. de Cuenta0000000001No. de ClienteC0000000No. Cuenta CLABE012 028 00000000001 8
...
Detalle de Movimientos RealizadosFECHASALDOOPERLIQDESCRIPCIONREFERENCIACARGOSABONOSOPERACIONLIQUIDACION26/DIC26/DICPAGO TARJETA DE CREDITO14,869.8748,441.9648,441.96 CUENTA: BMOV Referencia 500000000129/DIC29/DICSPEI ENVIADO BANORTE1,000.0047,441.9647,441.96 0912250pago-demo Referencia 500000000207/ENE07/ENEPAGO CUENTA DE TERCERO850.0046,591.9646,591.96 BNET 0000000001 TRANSFER DEMO Referencia 5000000003TOTAL IMPORTE CARGOS16,719.87TOTAL MOVIMIENTOS CARGOS3TOTAL IMPORTE ABONOS0.00TOTAL MOVIMIENTOS ABONOS0`

const realStyleMissingBalanceText = `BBVA
PeriodoDEL 23/01/2026 AL 22/02/2026Fecha de Corte 22/02/2026No. de Cuenta0000000001No. de ClienteC0000000No. Cuenta CLABE012 028 00000000001 8
Información FinancieraMONEDA NACIONALLibretón Básico Cuenta Digital
...
Detalle de Movimientos RealizadosFECHASALDOOPERLIQDESCRIPCIÓNREFERENCIACARGOSABONOSOPERACIÓNLIQUIDACIÓN02/ENE02/ENEPAGO CUENTA DE TERCERO2,498.0026,666.6226,666.620010000001 BNET 0000000001 FACTURA DEMO105/ENE04/ENECOMERCIO DEMO368.3026,298.3226,298.32******4242 USD 368.30TC001.0000AUT: 87569816/ENE16/ENEPAGO CUENTA DE TERCERO2,289.8328,588.1528,588.150010000002 BNET 0000000001 FACTURA DEMO2TOTAL IMPORTE CARGOS368.30TOTAL MOVIMIENTOS CARGOS1TOTAL IMPORTE ABONOS4,787.83TOTAL MOVIMIENTOS ABONOS2`

const realStyleCLABEFallbackText = `BBVA
PeriodoDEL23/02/2026AL24/03/2026Fecha de Corte24/03/2026No. Cuenta CLABE012 028 00000000002 8
...
PeriodoDEL 01/03/2026 AL 31/03/2026Fecha de Corte 31/03/2026No. de Cuenta0000000002No. de ClienteC0000000No. Cuenta CLABE012028000000000028PAGINA  1 / 5
Información FinancieraMONEDA DOLARESLibretón Dólares
Detalle de Movimientos RealizadosFECHASALDOOPERLIQDESCRIPCIÓNREFERENCIACARGOSABONOSOPERACIÓNLIQUIDACIÓN03/MAR03/MARPAGO CUENTA DE TERCERO2,081.67 0018183007  BNET 0111250892 CLIENTE EJEMPLO AB1203/MAR02/MARCLAUDE.AI SUBSCRIPTION20.0012,969.7112,931.98******0434  USD 20.00TC001.0000AUT: 83913904/MAR03/MARSTRIPE *AMAZON23.6312,946.0812,914.00******0434  RFC: DEMO010101AAA 07:26 AUT: 65993505/MAR03/MARAMAZON14.1012,931.9812,914.00******0434  RFC: DEMO010101AAA 20:13 AUT: 44507206/MAR04/MARSTRIPE *AMAZON17.9812,914.0012,905.64******0434  RFC: DEMO010101AAA 02:28 AUT: 07096909/MAR06/MARAMAZON MX DIGITAL8.3612,905.6412,905.64******0434  RFC: DEMO010101AAA 21:44 AUT: 14685612/MAR11/MARANTHROPIC5.0012,900.6412,900.64******0434  USD 5.00TC001.0000AUT: 63211120/MAR20/MARPAGO CUENTA DE TERCERO2,081.6714,982.3114,982.310027470008  BNET 0111250892 CLIENTE EJEMPLO CD34231/MAR31/MARPAGO CUENTA DE TERCERO2,706.1717,688.4817,688.480020825029  BNET 0111250892 CLIENTE EJEMPLO EF56
...
CLIENTE DEMO TU PAGO REQUERIDO ESTE PERIODO
TARJETA AZUL BBVA (CLASICA)
Numero de tarjeta: 4000000000004242
Periodo: 25-feb-2026 al 24-mar-2026
Pago para no generar intereses: $413.24
Numero de cuenta: XXXXXX4242 Pagina 2de6
DESGLOSE DE MOVIMIENTOS.
CARGOS,COMPRAS Y ABONOS REGULARES(NO A MESES) Tarjeta titular: XXXXXXXXXXXX4242
Fecha Fecha
...
operacién
04-mar-2026 04-mar-2026 BMOVIL.PAGO TDC. - $15,297.64
Numero de cuenta: XXXXXX4242 Pagina 3de6
CARGOS,COMPRAS Y ABONOS REGULARES(NO A MESES) Tarjeta titular: XXXXXXXXXXXX4242
Fecha Fecha
dela de cargo Descripcién del movimiento Monto
operacién
