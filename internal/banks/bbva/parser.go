...
func classifyByDescription(description string) edocuenta.TransactionDirection {
	...
	case strings.Contains(upper, "SPEI ENVIADO"),
		...
		strings.Contains(upper, "IVA COM MEMBRESIA"),
	...
	case strings.Contains(upper, "SPEI RECIBIDO"),
		...
		strings.Contains(upper, "SU PAGO EN EFECTIVO"),
		strings.Contains(upper, "BONIFICACION DE COMISION"),
		strings.Contains(upper, "BONIFICACION IVA COMISION"),
